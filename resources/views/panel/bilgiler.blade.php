                                ...
                                <form role="form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="kategori">
                                            ...
                                            <option value="{{ $kategori->id }}">{{ $kategori->katadi }}</option>
                                                @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="yil" value=""/>

                                    </div>
                                    <div class="form-group">
                                        <label>Başlık  <small>(Özgeçmiş başlıklarını giriniz)</small></label>

                                        <input class="form-control" name="baslik" value=""/>

                                    </div>
                                    <div class="form-group">
                                        <label>Açıklama</label>
                                        <textarea name="aciklama" id="yazi1"></textarea>
                                    </div>
